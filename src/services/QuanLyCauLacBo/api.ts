...
const initialApplications = [
  { id: 'app-1', fullName: 'Hoàng Minh Dương', email: 'hoangminhd@gmail.com', phoneNumber: '0987654321', gender: 'Nam', address: 'Hà Nội', strengths: 'Ca hát, guitar', clubId: '1', reason: 'Yêu thích âm nhạc từ nhỏ', status: 'Pending', rejectReason: '', createdAt: '2025-04-01T10:00:00Z' },
  { id: 'app-2', fullName: 'Phạm Thị Lan', email: 'phamthie@gmail.com', phoneNumber: '0912345678', gender: 'Nữ', address: 'Hồ Chí Minh', strengths: 'Vẽ màu nước', clubId: '2', reason: 'Muốn học hỏi thêm về hội họa', status: 'Approved', rejectReason: '', createdAt: '2025-04-02T15:30:00Z' },
  { id: 'app-3', fullName: 'Vũ Văn Phong', email: 'vuvanf@gmail.com', phoneNumber: '0901234567', gender: 'Nam', address: 'Đà Nẵng', strengths: 'Phản xạ nhanh', clubId: '3', reason: 'Muốn thi đấu chuyên nghiệp', status: 'Rejected', rejectReason: 'Không đủ tuổi tham gia', createdAt: '2025-04-03T09:15:00Z' }
];
